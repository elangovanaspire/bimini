...
if (function_exists("register_field_group")) {
	...
	?>',
            ...
            array(
                ...
                'name' => 'map',
                'type' => 'validated_field',
                'instructions' => 'Use jpg or png file with minimum resolution 768px X 1024px	and max size upto 2MB',
                'required' => 1,
                'read_only' => 'false',
                'drafts' => 'true',
                'sub_field' => array(
                ...
                'pattern' => '$meta_values = get_post_meta($value,\'_wp_attachment_metadata\');
                    if(count($meta_values)<=0) {
                        $message="Upload image with minimum pixels 768*1024";
			return false;
                    }
	$width=$meta_values[0][\'width\'];
	$height=$meta_values[0][\'height\'];
    ...
    register_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'name' => 'menu',
                'type' => 'validated_field',
                'instructions' => 'Use pdf file max size upto 2MB',
                'required' => 1,
                'read_only' => 'false',
                'drafts' => 'true',
                'sub_field' => array(
                ...
                'mask' => '',
                'function' => 'php',
                'pattern' => '$meta_values = get_post_meta($value, \'_wp_attached_file\');
	if(count($meta_values)<=0){
			$message = "Upload only pdf file";
			return false;
	}
	$ext = pathinfo($meta_values[0], PATHINFO_EXTENSION);
	if($ext != \'pdf\'){
	$message = "Upload only pdf file";
	return false;
	}
	...
	return false;
        ...
        //Added by Sajjad
        register_field_group(array(
        'id' => 'acf_resort_packages',
        'title' => 'resort_packages',
        'fields' => array(
            array(
                'key' => 'field_546b480f479d4',
                'label' => 'Logo',
    ...
    //Added by Sajjad
    register_field_group(array(
        'id' => 'acf_casino_promotions',
        'title' => 'casino_promotions',
        'fields' => array(
            array(
                'key' => 'field_546b480f479d4',
                'label' => 'Logo',
    ...
    //Added by Sajjad
        register_field_group(array(
        'id' => 'acf_cruise_packages',
        'title' => 'cruise_packages',
        'fields' => array(
            array(
                'key' => 'field_546b480f479d4',
                'label' => 'Logo',
    ...
    register_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'name' => 'front_banner_image',
                'type' => 'validated_field',
                'instructions' => 'Use jpg or png file with resolution 468px X 282px	and max size upto 2MB',
                'required' => 1,
                'read_only' => 'false',
                'drafts' => 'true',
                'sub_field' => array(
                ...
                'pattern' => '$meta_values = get_post_meta($value,\'_wp_attachment_metadata\');
                    if(count($meta_values)<=0) {
                        $message="Upload image with pixels 468*282";
			 return false;
                    }
	$width=$meta_values[0][\'width\'];
	$height=$meta_values[0][\'height\'];
	 if($width<>\'468\' || $height<>\'282\'){
			 $message="Upload image with pixels 468*282";
			 return false;
	 }else {
			 return true;
    ...
    //Sajjad Added 
        register_field_group(array(
        'id' => 'acf_cruise_booking',
        'title' => 'cruise_booking',
        'fields' => array(
            array(
                'key' => 'field_546b49dfec95b',
                'label' => 'Description',
    ...
    register_field_group(array(
        'id' => 'acf_menu-category1',
        'title' => 'Menu Category1',
        'fields' => array(
            array(
                'key' => 'field_54a3cbebb5ac5',
                'label' => 'Description',
                'name' => 'content',
                'type' => 'textarea',
                'required' => 1,
    ...
    register_field_group(array(
        'id' => 'acf_banner-description',
        'title' => 'Banner Description',
        'fields' => array(
            array(
                'key' => 'field_54a3d041368a2',
                'label' => 'Description',
                'name' => 'description',
                'type' => 'wysiwyg',
                'required' => 1,
    ...
    register_field_group(array(
        'id' => 'acf_responsible-gaming1',
        'title' => 'Responsible Gaming1',
        'fields' => array(
            array(
                'key' => 'field_54a63af9b540e',
                'label' => 'Speed Dial',
                'name' => 'speed_dial',
                'type' => 'validated_field',
                'required' => 1,
		...
		?>',
            ...
            array(
			 ...
			 return false;
                    ...
                    if(count($meta_values)<=0) {
                        $message = "Invalid format. Upload image with pixels 468*228";
                        return false;
                    }
		$width=$meta_values[0][\'width\'];
		$height=$meta_values[0][\'height\'];
    ...
    register_field_group(array(
        'id' => 'acf_pacific-sunsets',
        'title' => 'Pacific Sunsets',
        'fields' => array(
            array(
                'key' => 'field_552b643ab2b7f',
                'label' => 'Detailed Page - Banner Image',
                'name' => 'banner_image',
                'type' => 'validated_field',
                'instructions' => 'Use jpg or png file with resolution 1441px X 450px and max size upto 2MB',
    ...
    register_field_group(array(
        'id' => 'acf_restaurants-and-bars1',
        'title' => 'Restaurants and bars1',
        'fields' => array(
            array(
                'key' => 'field_54a68f37138a9',
                'label' => 'Detailed Page - Reserve Online',
                'name' => 'external_link',
                'instructions' => 'Starts with (http:// or https:// or www.)',
                'type' => 'validated_field',
                'read_only' => 'false',
                'drafts' => 'true',
                'sub_field' => array(
                    ...
                    'key' => 'field_54a68f37138a9',
                    'name' => 'external_link1',
                    '_name' => 'external_link1',
                    'id' => 'acf-field-external_link1',
                    'value' => '',
                    'field_group' => 1227,
                    'default_value' => '',
                    'placeholder' => '',
